...
- [ ] 1.1 `tests/test_docs_exports.py`: replace the three-way reconciliation
...
- [ ] 4.1 Doc tests green; the manual builds with `-W` in the workspace venv
...
- [ ] 4.2 Validate, sync the delta, archive, commit.
