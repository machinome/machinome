...
- [ ] 1.1 Add focused nested-joint tests that first fail with the bank, bound
  coordinate and rendered pose disagreeing after independent parent and child
  movement under the current delivery.
- [ ] 1.2 Prove the failure depends on complete-bank insertion order, then pin
  equal normal-order and reverse-order results as the acceptance contract.
- [ ] 1.3 Pin compatibility before implementation: bare coordinate/coordinate
...
- [ ] 5.2 Run strict OpenSpec validation and final targeted and regression tests,
