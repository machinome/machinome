# Preserved historical-Pascaline-first roadmap — 13 September 2026

Status: historical planning snapshot. The pilot subsequently selected
`Calculators/Pascaline-module` as the first feature-development project,
the full historical Pascaline second, and Curta third. The latter two are
stress tests and do not gate the module-developed first increment.

The original roadmap below is preserved verbatim from framework checkpoint
`67b767ae40c7058bbc38c174b365ff576fd6d301`. Its first-project wording,
readiness dependencies and instructions to prepare the historical Pascaline
with the initial package changes are superseded by [the active roadmap](roadmap.md).
Its evidence, retained-contact decision and unfinished historical-machine
obligations remain valid records for the second stage. No measurement is
repeated or gate passed by this scheduling change.
