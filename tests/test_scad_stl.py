...
class FlatStlTest(BaseNodeTest, FlatTest):
    ...
    def test_two_cylinders_first_render(self):
        ...
        self.assertCode("""
        union() {
            import(file = "simple_cylinder-SimpleCylinder,10,5-ca58d4c6134a.stl", origin = [0, 0]);
            cylinder(h = 10, r = 5);
        }
        """)
    ...
    def test_two_cylinders_second_render(self):
        ...
        union() {
            import(file = "simple_cylinder-SimpleCylinder,10,5-ca58d4c6134a.stl", origin = [0, 0]);
            import(file = "simple_cylinder-SimpleCylinder,5,10-e4399a6a2924.stl", origin = [0, 0]);
        }
        """)
...
class DeepStlTest(BaseNodeTest):
    ...
    def test_third_level(self):
        ...
        union() {
            union() {
                union() {
                    import(file = "one/two/three/simple_cylinder-SimpleCylinder,10,5-ca58d4c6134a.stl", origin = [0, 0]);
        cylinder(h = 10, r = 5);
                }
                rotate(a = 180, v = [1, 0, 0]) {
                    union() {
