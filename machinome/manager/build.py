...
from machinome.core.builder import Builder, BuildOutcome, write_error
...
def build_once(path, overrides):
    ...
    always ends it.  See `machinome.core.processes`.
    """
    Builder(
        path,
        watch=False,
    ...
    def build_all(self, path):
        ...
        for model in project.models:
            ...
            try:
                ...
                # several, recorded where `machinome models` will find it, and
                # the walk goes on.
