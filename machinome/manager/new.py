...
class New:
    """Create a new machinome project with a starting structure."""
    ...
    def handle(self, args):
        ...
        # the raw argument: `machinome new snowman-3` must not leave a hyphen in
        ...
        print(f"Created new machinome project at {target}/")
        print()
        print("Next steps:")
        print(f"  cd {target}")
        print("  machinome develop")
